...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private final long MIN_TIME = 600;
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                try {
                    ...
                    String phNum = "+917042532355";
                    String phNum1="+916386143751";
                    String myLat = String.valueOf(location.getLatitude());
                    String myLon = String.valueOf(location.getLongitude());
                    String msg = "HELP NEEDE! FIND ME HERE: https://www.google.com/maps/@" + myLat + "," + myLon+",15z";
                    SmsManager smsManager = SmsManager.getDefault();
                    smsManager.sendTextMessage(phNum, null, msg, null, null);
                    smsManager.sendTextMessage(phNum1, null, msg, null, null);
